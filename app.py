...
Hr = {
     'User-Agent': "Dalvik/2.1.0 (Linux; U; Android 15; SM-A065F Build/AP3A.240905.015.A2)",
...
async def GeNeRaTeAccEss(access_token):
...
async def EncRypTMajoRLoGin(open_id, access_token, platform):
    ...
    major_login.platform_id = platform
    major_login.client_version = "1.118.9"
    major_login.system_software = "Android OS 7.1.2 / API-25 (NJH47F/0bd21c4734)"
    major_login.system_hardware = "Handheld"
    major_login.network_type = "WIFI"
    major_login.screen_width = 960
    major_login.screen_height = 540
    major_login.screen_dpi = "270"
    major_login.processor_details = "ARMv7 VFPv3 NEON | 1300 | 4"
    major_login.memory = 3003
    major_login.gpu_renderer = "Mali-T720"
    major_login.gpu_version = "OpenGL ES 3.1 v1.r15p0-00rel0.98e69a4d293675cb3e24ddfee048abf6"
    major_login.unique_device_id = "Google|f86ed7dc-612f-4c2e-b8a7-9b0ec6ad27de"
    major_login.client_ip = "196.115.79.33"
    major_login.language = "ar"
    major_login.open_id = open_id
    major_login.open_id_type = str(platform)
    ...
    major_login.library_path = "/data/app/com.dts.freefireth-1/lib/arm"
    major_login.reg_avatar = 1
    major_login.library_token = "2087f61c19f57f2af4e7feff0b24d9d9|/data/app/com.dts.freefireth-1/base.apk"
    major_login.channel_type = 3
    major_login.cpu_type = 2
    major_login.cpu_architecture = "32"
    major_login.client_version_code = "2019119027"
    major_login.graphics_api = "OpenGLES2"
    major_login.supported_astc_bitset = 16383
    major_login.login_open_id_type = platform
    major_login.loading_time = 13564
    major_login.release_channel = "android"
    major_login.if_push = 1
    major_login.is_vpn = 0
    major_login.origin_platform_type = str(platform)
    major_login.primary_platform_type = str(platform)
                    ...
                    if response:
                        ...
                        if inPuTMsG.strip().startswith('!e'):
                            ...
                            try:
                                ...
                                message = f'[B][C]{get_random_color()}\nACITVE TarGeT -> {xMsGFixinG(uid)}\n \n[B][C][FF6347] For Find Emote Id (code)\n Visit [7CFC00][U] https://shadow-emote-list(dot)vercel(dot)app\n'
...
async def MaiiiinE():
    access_token = "20514fb926d90678009263cb3cad77892602a7761376351eb1ce039783467151"
    
    open_id , platform = await GeNeRaTeAccEss(access_token)
    ...
    os.system('clear')
    print(render('LOGIN FF', colors=['white', 'green'], align='center'))
    print('')
    print(f" - START: {TarGeT}  NAME : {acc_name}\n")
    print(f" - ONLINE !")    
    print(f" - BY MOHAMED BOUGRINA")    
    await asyncio.gather(task1 , task2)
    
async def StarTinG():
    while True:
        try: await asyncio.wait_for(MaiiiinE() , timeout = 7 * 60 * 60)
        except asyncio.TimeoutError: print("Token error")
